            ...
            <div class="col* col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @else
                        <form action="{{ route('services.update', $currentdata) }}" id="form"
                        ...
                        @endif
                            ...
                            <div class="form-group" id="single-image">
                                ...
                                <input type="file" name="coverimage"   data-default-file="{{ isset($currentdata) ? $currentdata->getServiceImageUrl() : '' }}" id="input-file-now" class="dropify" />
